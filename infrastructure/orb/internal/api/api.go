...
func (h *Handler) routes() {
	...
	h.mux.Handle("GET /v1/account/partner", h.auth(h.getPartner))
	h.mux.Handle("PUT /v1/account/partner", h.auth(h.putPartner))
	h.mux.Handle("DELETE /v1/account/partner", h.auth(h.deletePartner))
