...
/// The iOS SDK began defining CGFLOAT_EPSILON as a macro in CFCGTypes.h, which
/// expands this declaration into `extern CGFloat const DBL_EPSILON` and fails to
/// parse. Defer to the SDK's definition when it is present.
