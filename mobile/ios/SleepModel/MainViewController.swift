...
extension MainViewController: HEMSystemAlertDelegate, HEMPresenterErrorDelegate {
    ...
    @objc func showError(withTitle title: String?, andMessage message: String, withHelpPage helpPage: String?, from presenter: HEMPresenter) {
    ...
    @objc func present(_ controller: UIViewController, from presenter: HEMSystemAlertPresenter) {
    ...
    @objc func dismissCurrentViewController(from presenter: HEMSystemAlertPresenter) {
        self.dismiss(delay: MainViewController.alertDismissDelay, animated: true, completion: nil)
    }
    
    @objc func presentSupportPage(withSlug supportPageSlug: String,
...
extension MainViewController: UITabBarControllerDelegate {
    ...
    @objc func tabBarController(_ tabBarController: UITabBarController,
...
extension MainViewController: Themed {
    ...
    @objc func didChange(theme: Theme, auto: Bool) {
        if auto == true {
            self.reloadAllTabs()
        } else {
