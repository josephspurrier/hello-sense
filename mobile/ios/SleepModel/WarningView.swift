...
extension WarningView {
    ...
    @objc static func messageAttributes() -> [NSAttributedString.Key : Any] {
        ...
        return [NSAttributedString.Key.font : detailFont,
                NSAttributedString.Key.foregroundColor : detailColor,
