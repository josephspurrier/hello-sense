...
@objcMembers class StatusMesssageView: UIView {
    ...
    @objc convenience init(width: CGFloat,
                     image: UIImage,
                     title: String,
                     message: String) {
    ...
    fileprivate func addMessageLabel(titleFrame: CGRect) -> CGRect {
        ...
        let messageAttributes: [NSAttributedString.Key : Any] = [NSAttributedString.Key.font : UIFont.body(),
                                                NSAttributedString.Key.foregroundColor : UIColor.grey5(),
