...
@objcMembers class NightModeSettingsPresenter: HEMListPresenter {
    ...
    fileprivate func locationFooter() -> UIView {
        ...
        let attributedLink = NSAttributedString(string: linkText).hyperlink(UIApplication.openSettingsURLString)!
        let text = NSMutableAttributedString(format: textFormat, args: [attributedLink], attributes: attributes)
        let textView = UITextView()
        textView.attributedText = text
        textView.isEditable = false
        textView.linkTextAttributes = [NSAttributedString.Key.foregroundColor : linkColor, NSAttributedString.Key.font : font]
